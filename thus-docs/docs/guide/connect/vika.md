...
我们提供保姆级（小白也能用！）的简易配置方法，让你轻松把如是上的记事备份到 Vika 维格云上☁️
...
将它们分别粘贴到 [如是](https://my.liubai.cc/connect/vika) 上：
...
现在你可以回到 [如是](https://my.liubai.cc/) 上记录，同时观察你的 vika 有没有来自如是的记事！
